    ...
    function createOrder(data, actions) {
        return actions.order
            .create({
                purchase_units: [
                    {
                        amount: { value: order.totalPrice * 0.00073 },
                    },
                ],
            })
            .then((orderID) => {
                    ...
                    <div>
                        <div className="flex ">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                {order.isDelivered ? (
                                    <Message bg="text-green-500 bg-transparent border border-green-500">
                                        Delivered
                                    </Message>
                                ) : (
                        ...
                        <div>
                            ...
                            {order.isPaid ? (
                                <Message bg="border border-green-600 bg-green-100 inline-block">
                                    Paid on {order.paidAt.substring(0, 10)}
                                </Message>
                            ) : (
                                <Message bg="border border-red bg-red-200">
                                    Not Paid
                                </Message>
                            )}
                        </div>
